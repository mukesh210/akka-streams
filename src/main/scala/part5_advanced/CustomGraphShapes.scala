...
/**
  * Problem: Try to create M*N Balance
  * Components with arbitary number of inputs and outputs
  *
  * Can not solve using what we already know because there is no shape
  * which takes arbitary number of inputs and outputs
  *
  */
object CustomGraphShapes extends App {
  ...
  /**
    * Exercise: generalize the balance component, make it M*N
    */
